...
class User(models.Model):
    ...
    follows = models.ManyToManyField("self", verbose_name = "关注用户", through = "Followship", symmetrical=False, related_name='follow_set')
    friends = models.ManyToManyField("self", verbose_name = "好友", through = "Friendship", symmetrical=False, related_name='friend_set')
...
class Comment(models.Model):
    ...
    msg = models.ForeignKey(Message, on_delete = models.CASCADE, verbose_name = "该评论所属信息", default = '')
...
class Friendship(models.Model):
    initiator = models.ForeignKey(User, on_delete = models.CASCADE, verbose_name = "发起申请的用户", related_name='initiator_set')
    recipient = models.ForeignKey(User, on_delete = models.CASCADE, verbose_name = "接受申请的用户", related_name='recipient_set')
    date = models.DateField("成为好友的日期", default = timezone.now)

class Followship(models.Model):
    followed_user = models.ForeignKey(User, on_delete = models.CASCADE, verbose_name = "被关注者", related_name='followed_user_set')
    fan = models.ForeignKey(User, on_delete = models.CASCADE, verbose_name = "粉丝", related_name='fan_set')
